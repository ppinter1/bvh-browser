...
/* Math routines to support BVH class */
    ...
    public:
        ...
        class Transform {
            ...
            public:
                ...
                void toMatrix (float* m) {              // Quaternion to rotation matrix
                    ...
                    m[12] = offset.x;                   // position
                    m[13] = offset.y;
                    m[14] = offset.z;
                    
                    m[3]  = m[7] = m[11] = 0;           // Bottom row
                    m[15] = 1;
                }
        };
        ...
        static inline void multMatrix (const float* a, const float* b, float* out) {
